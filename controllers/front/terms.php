...
class RzetelnyRegulaminProTermsModuleFrontController extends ModuleFrontController
{
    public function initContent()
    {
        if (Configuration::get('rr_user_code_'.Context::getContext()->language->id) != '') {
            ...
            if (version_compare(_PS_VERSION_, '1.7.0', '<') === true) {
                ...
                $this->setTemplate('module:rzetelnyregulaminpro/views/templates/front/terms-1-7.tpl');
            }
        } else {
